      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (res.data.status === "success") {
            (0, _alerts.showAlert)("success", "User successfully managed logged in");
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          res = _context2.sent;
          if (res.data.status === "success") {
            (0, _alerts.showAlert)("success", "User successfully logged out");
            window.setTimeout(function () {
              location.assign("/");
            }, 1500);
          }
...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = "pk.eyJ1IjoibGlyb25lZml0b3Vzc2kiLCJhIjoiY2x0NXF4azRnMDNjZTJxcGRkbjMxdWo2aiJ9.CdWsopX-B91jgnAx_Qs7tg";
      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          ...
          if (res.data.status === "success") {
            ...
            (0, _alerts.showAlert)("error", "There was an error updating");
          }
          _context.next = 11;
          break;
        case 8:
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } /* eslint-disable*/
var stripe = Stripe("pk_test_51Opx9pAjqUE4YDqZLf6fzME4KZrAIVx7okss6myVeXzPumAwublVuyil1BNC5u1YtIQWw6clj6N68LzZUwkqgX5l00CUtanAlg");
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            ...
            passwordCurrent = e.target.passwordCurrent.value;
            password = e.target.password.value;
